...
describe('example', function () {
    ...
    it('example #2 (testdata/example.md:20:1) should succeed', function () {
        var __returnValue1;
        example1:
            try {
                var Timelock = function Timelock(value, delay) {
    ...
    it('example #3 (testdata/example.md:48:1) should fail with the correct error message', function () {
        var __returnValue1;
        example1:
            try {
                var Timelock = function Timelock(value, delay) {
        ...
        function endOfExample1(err) {
            ...
            function endOfExample2(err) {
                ...
                example3:
                    try {
                        __returnValue3 = expect(new Timelock('Hello world!', 5), 'to satisfy', expect.it('not to match', /!/));
                        break example3;
                    } catch (err) {
